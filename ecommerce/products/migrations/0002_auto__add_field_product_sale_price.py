...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'products_product', 'sale_price',
                      self.gf('django.db.models.fields.DecimalField')(default=29.99, null=True, max_digits=100, decimal_places=2, blank=True),
                      keep_default=False)
    ...
    models = {
        u'products.product': {
            ...
            'sale_price': ('django.db.models.fields.DecimalField', [], {'default': '29.99', 'null': 'True', 'max_digits': '100', 'decimal_places': '2', 'blank': 'True'}),
